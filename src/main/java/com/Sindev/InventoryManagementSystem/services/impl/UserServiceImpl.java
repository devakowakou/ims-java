...
import com.Sindev.InventoryManagementSystem.enums.UserRole;
import com.Sindev.InventoryManagementSystem.exceptions.InvalidCredentialsException;
...
import com.Sindev.InventoryManagementSystem.repositories.UserRepository;
import com.Sindev.InventoryManagementSystem.security.JwtUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Response loginUser(LoginRequest loginRequest) {
        ...
        // Create UserDTO from user (excluding transactions for security)
        ...
        return Response.builder()
                ...
                .user(userDTO)  // ← Add user information to response
                .build();
    }
    ...
    public Response updateUser(Long id, UserDTO userDTO) {
        ...
        if (userDTO.getEmail() != null) existingUser.setPhoneNumber(userDTO.getPhoneNumber());
        if (userDTO.getPhoneNumber() != null) existingUser.setEmail(userDTO.getEmail());
